...
9. **Hero no celular: problema de PROPORÇÃO, não de colisão (25/09, aberto, adiado pelo Diogo pra rever "a estrutura toda").** Desktop aprovado ("perfeito do jeito que ficou"). No celular o texto "come a tela toda": eyebrow (2 linhas) + H1 (3 linhas) + lede (3 linhas) + 2 CTAs ≈ 70% da altura, e a foto vira fundo escuro. A referência que ele aprovou é a capa da revista (`materiais/revista/visita.html`): imagem domina, título ocupa pouco, quase nada além dele. **Erro de leitura registrado:** as Rodadas 8–9 trataram isso como colisão (texto encostando em ícone/header/WhatsApp) e corrigiram posição — o Diogo disse que não era esse o problema. Direção provável quando for retomado (a decidir com ele, não implementar sem perguntar): no mobile, reduzir o volume de texto na hero (lede sai ou vira 1 linha, eyebrow em 1 linha, 1 CTA só) e dar a altura de volta à foto, em vez de só diminuir fonte.
